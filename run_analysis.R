# Course Project in Getting and Cleaning Data - Data Science Specialization (JHU Coursera)
...
#The merged dataset "tidyData.txt" is available on the GitHub repository along with this script, the codebook, and the README file. 
